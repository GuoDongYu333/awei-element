...
describe("Button.vue", () => {
  ...
  test("basic button", async () => {
    ...
    // class
    expect(wrapper.classes()).toContain("ez-button--primary");
  ...
  test("loading button", () => {
    ...
    //@ts-ignore
    expect(iconElement?.componentVM.icon).toBe("spinner");
  });
  ...
  test("icon button", () => {
    ...
    expect(iconElement.exists()).toBeTruthy();
    //@ts-ignore
    expect(iconElement?.componentVM.icon).toBe("arrow-up");
  });
  ...
  it("should has the correct type class when type prop is set", () => {
    ...
    types.forEach((type) => {
      ...
      expect(wrapper.classes()).toContain(`ez-button--${type}`);
    });
  });
  ...
  it("should has the correct size class when size prop is set", () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(wrapper.classes()).toContain(`ez-button--${size}`);
    });
  });
...
describe("ButtonGroup.vue", () => {
  test("basic button group", async () => {
    ...
    expect(wrapper.classes()).toContain("ez-button-group");
  });
  ...
  test("button group size", () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(buttonWrapper.classes()).toContain(`ez-button--${size}`);
    });
  });
  ...
  test("button group type", () => {
    ...
    types.forEach((type) => {
      ...
      const buttonWrapper = wrapper.findComponent(Button);
      expect(buttonWrapper.classes()).toContain(`ez-button--${type}`);
    });
  });
